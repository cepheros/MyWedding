...
class UsersTest extends ModelTestCase
{
    ...
    public function testInputFilterValid($if)
    {
        ...
        $this->assertTrue($if->has('userEmail'));
        $this->assertTrue($if->has('phoneNumber'));
        $this->assertTrue($if->has('dateCreated'));
        $this->assertTrue($if->has('dateLastLogin'));
        $this->assertTrue($if->has('ipLastLogin'));
        $this->assertTrue($if->has('userSignature'));
        $this->assertTrue($if->has('recoveryPass'));
    }
    ...
    public function testInputFilterInvalido()
    {
        ...
        $post->userName = 'Lorem Ipsum é simplesmente uma simulação de texto da indústria 
